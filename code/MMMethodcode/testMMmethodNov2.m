function [ MMbyidimstats, Runstats, MMsummary,MM,uidim ] = testMMmethodNov2( testcaseid,dirname )
...
if length(testcaseid) == length('LIDAR') & testcaseid == 'LIDAR'
    ...
    idimfigs = 1;   
    [data,idim] = computevidim( data,radii,K,varthreshhold,epszero,idimfigs,TVfigs,fname1);
