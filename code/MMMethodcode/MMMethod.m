function [MMbyidimstats,MMsummary,MM,uidim,Runstats ] = MMMethod(data,idim,testproportion,runs, seed,eps,SVDbound,maxscale,K,varthresh,confidencebound, figs,fname )
...
[ MMsummary,MM] = MultiManifold(ndata,idim,SVDbound,maxscale,K, varthresh,eps);
...
for i = 1:runs
    ...
    [ trainMMsummary,trainMM] = MultiManifold(traindata,trainidim,SVDbound,maxscale,K, varthresh,eps);
    [TDtoMM] = TDtoMMbyidim( testdata,testidim,trainMM,trainuidim);
